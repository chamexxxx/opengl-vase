...
int main()
{
    ...
    // loading model
    Model vaseModel("resources/objects/vase/vase.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // exchange of the contents of the front and back buffers
        glfwSwapBuffers(window);
        // checking and processing events
        glfwPollEvents();
    }
