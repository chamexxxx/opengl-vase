...
int main()
{
    ...
    // tell stb_image.h to flip the loaded textures around the y-axis (before loading the model)
    ...
    // specifying cubeVertices (and buffers) and setting vertex attributes
    float cubeVertices[] = {
    ...
    // coordinates of point light sources
    ...
    // adjust the VAO of the light
    // (the VBO remains the same; the cubeVertices are the same for the light object, which is also a 3D cube)
    ...
    // update the step of the lamp position attribute to reflect the updated buffer data
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // draw as many lamps as we have point light sources
        glBindVertexArray(lightCubeVAO);
